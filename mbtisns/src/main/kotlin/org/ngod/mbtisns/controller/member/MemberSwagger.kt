...
interface MemberSwagger {
    ...
    fun followUser(authorization: String, myId: Long, followId: Long): ApiResponse<Account>;

    @Operation(summary = "팔로우 취소", description = "팔로우 취소")
    fun unFollowUser(authorization: String, myId: Long, followId: Long): ApiResponse<Account>

    @Operation(summary = "유저 조회", description = "id 를 기반으로 유저 조회")
    fun getMember(authorization: String, memberId: Long): ApiResponse<Member>
    ...
    fun getRecommendUser(): ApiResponse<List<Member>>
}