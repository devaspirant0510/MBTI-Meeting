...
interface AuthSwagger {
    ...
    fun getAuthById(accountId:Long):org.ngod.mbtisns.core.ApiResponse<Account>

    @Operation(summary = "마스터 토큰 발급", description = "테스트용 유효기간 없는 토큰", method = "get")
    @ApiResponses(value = [ApiResponse(responseCode = "200", description = "마스터 jwt 토큰 발급")])
    fun getMasterToken(): ResponseEntity<org.ngod.mbtisns.core.ApiResponse<String>>
    ...
    fun getUser(
        ...
        token: String
    ): org.ngod.mbtisns.core.ApiResponse<Account>
    ...
    ): org.ngod.mbtisns.core.ApiResponse<JwtBody>
