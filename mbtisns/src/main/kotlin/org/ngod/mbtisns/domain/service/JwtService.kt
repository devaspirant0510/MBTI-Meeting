...
class JwtService {
    ...
    fun generateMasterToken(): String {
        ...
        val jwtValue = Jwts.builder()
            .setSubject("45a25708-e40b-4c8e-983c-0e265bf66533") // 토큰의 주제
            .setIssuedAt(now) // 발급 시간
            .setExpiration(expiryDate) // 만료 시간
            .claim("id", 1) // 추가 데이터
            .claim("provider", "kakao")
            .claim("sub", "45a25708-e40b-4c8e-983c-0e265bf66533")
            .claim("email", "nova020510@naver.com")
            .claim("createdAt", "2024-10-04T10:21:39.243214")
            .claim("member", mapOf(
                "id" to 1,
                "nickName" to "인텔떡상기원3년차",
                "mbti" to "INTP",
